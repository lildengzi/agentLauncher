...
const zh: Dict = {
  ...
  "console.clear": "清空日志",
  "console.close": "关闭",
  "console.openWeb": "打开 dsh 网页",
  "console.readonlyHint": "只读日志 · 交互请在 dsh 网页中进行",
...
const en: Dict = {
  ...
  "console.close": "Close",
  "console.openWeb": "Open dsh web UI",
  "console.readonlyHint": "Read-only log · interact in the dsh web UI",
